...
import ProductTypeImport from 'index.js'
import getApiCredentials from '@commercetools/helper-get-api-credentials'
...
const before = function setupSphereCreds () {
  const options = {
    config: getApiCredentials('PRODUCT_TYPE_IMPORT'),
  }
